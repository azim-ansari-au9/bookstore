...
exports.signin = (req, res) => {
    ...
    User.findOne({ email }, (err,user) => {
        ...
        //if user is found sure that email and password match
        //create authenticataion in user model
        if(!(password)) {
            return res.status(401).json({
                error: "Email and pasword don't match"
            });
        }
...
//isAuth routes to protect the routes
...
// Admin auth routes to protect the routes
